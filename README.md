<p align="center">
	<a href="https://anqin.cc/" target="_blank">
		<img src="https://images-1319591454.cos.ap-nanjing.myqcloud.com/images/2023-9-22%2015%3A17%3A15logo.png" alt="ABlog logo" style="width: 200px; height: 200px">
	</a>
</p>
<p align="center">
...
基于 [NBlog](https://github.com/Naccl/NBlog) 修改
...
docker-compose 部署 可查看 docker/docker-compose.yml文件
...
- 数据库中默认用户名密码为`Admin`，`123456`，因为是个人博客，没打算做修改密码的页面，可在`top.aqlog.util.HashUtils`下的`main`方法手动生成密码存入数据库
...
感谢 [NBlog](https://github.com/Naccl/NBlog)
