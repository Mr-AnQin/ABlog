...
-- Records of about
-- ----------------------------
INSERT INTO `about` VALUES (1, 'title', '标题', '关于帅气的 aqlog');
...
-- ----------------------------
INSERT INTO `site_setting` VALUES (1, 'blogName', '博客名称', 'aqlog\'s Blog', 1);
INSERT INTO `site_setting` VALUES (2, 'webTitleSuffix', '网页标题后缀', ' - aqlog\'s Blog', 1);
...
INSERT INTO `site_setting` VALUES (5, 'copyright', 'Copyright', '{\"title\":\"Copyright © 2019 - 2022\",\"siteName\":\"aqlog\'S BLOG\"}', 1);
...
INSERT INTO `site_setting` VALUES (10, 'name', '昵称', 'aqlog', 2);
INSERT INTO `site_setting` VALUES (11, 'rollText', '滚动个签', '\"云鹤当归天，天不迎我妙木仙；\",\"游龙当归海，海不迎我自来也。\"', 2);
INSERT INTO `site_setting` VALUES (12, 'github', 'GitHub', 'https://github.com/aqlog', 2);
INSERT INTO `site_setting` VALUES (13, 'telegram', 'Telegram', 'https://t.me/aqlogOfficial', 2);
...
INSERT INTO `site_setting` VALUES (21, 'badge', '徽标', '{\"title\":\"本博客已开源于 GitHub\",\"url\":\"https://github.com/aqlog/NBlog\",\"subject\":\"NBlog\",\"value\":\"Open Source\",\"color\":\"brightgreen\"}', 3);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'Admin', '$2a$10$4wnwMW8Z4Bn6wR4K1YlbquQunlHM/4rvudVBX8oyfx16xeVtI6i7C', 'Admin', '/img/avatar.jpg', 'admin@anqin.cc', '2020-09-21 16:47:18', '2020-09-21 16:47:22', 'ROLE_admin');
