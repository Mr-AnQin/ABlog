...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody top.aqlog.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody top.aqlog.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(top.aqlog.model.dto.Blog blog, String type) {
		//验证普通字段
