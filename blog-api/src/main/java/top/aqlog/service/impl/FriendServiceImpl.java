...
import top.aqlog.mapper.FriendMapper;
import top.aqlog.mapper.SiteSettingMapper;
...
public class FriendServiceImpl implements FriendService {
	...
	@Override
	public List<top.aqlog.model.vo.Friend> getFriendVOList() {
	...
	@Transactional(rollbackFor = Exception.class)
	@Override
	public void updateFriend(top.aqlog.model.dto.Friend friend) {
