package top.aqlog.util.comment;
...
import top.aqlog.constant.PageConstants;
...
import top.aqlog.service.FriendService;
...
import top.aqlog.util.QQInfoUtils;
import top.aqlog.util.StringUtils;
import top.aqlog.util.comment.channel.ChannelFactory;
import top.aqlog.util.comment.channel.CommentNotifyChannel;
import top.aqlog.enums.CommentOpenStateEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, top.aqlog.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(top.aqlog.entity.Comment parentComment, Comment comment) {
