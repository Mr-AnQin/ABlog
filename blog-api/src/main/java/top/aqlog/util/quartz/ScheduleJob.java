package top.aqlog.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import top.aqlog.entity.ScheduleJobLog;
import top.aqlog.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		top.aqlog.entity.ScheduleJob scheduleJob = (top.aqlog.entity.ScheduleJob) context.getMergedJobDataMap().get(top.aqlog.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
