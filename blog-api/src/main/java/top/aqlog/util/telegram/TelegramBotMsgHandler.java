package top.aqlog.util.telegram;
...
import top.aqlog.config.properties.TelegramProperties;
...
import top.aqlog.service.MomentService;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			top.aqlog.model.dto.Comment comment = new top.aqlog.model.dto.Comment();
